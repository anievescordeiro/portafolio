...
3. **Natural Language Processing** task: in this repo you'll see a little interesting NPL task for a job application. Given a dataset of dog names in Zurich, the goal is to find all names that have a **Levenshtein** distance of 1 to the word "Luca". This is a really nice technical question about fuzzy string match in Python to learn how use the **Levenshtein** package 📐📏 to approximately match strings and determine how similar they are. 
